...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'page_page_rawcontent', (
            ...
            (u'parent', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'rawcontent_set', to=orm['page.Page'])),
            (u'region', self.gf('django.db.models.fields.CharField')(max_length=255)),
            (u'ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    models = {
        ...
        u'page.rawcontent': {
            'Meta': {'ordering': "[u'ordering']", 'object_name': 'RawContent', 'db_table': "u'page_page_rawcontent'"},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'ordering': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'rawcontent_set'", 'to': u"orm['page.Page']"}),
            u'region': ('django.db.models.fields.CharField', [], {'max_length': '255'}),

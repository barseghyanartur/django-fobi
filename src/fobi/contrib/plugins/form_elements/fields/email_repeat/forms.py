...
__title__ = "fobi.contrib.plugins.form_elements.email_repeat.forms"
__author__ = "Artur Barseghyan <artur.barseghyan@gmail.com>"
__copyright__ = "2014-2019 Artur Barseghyan"
__license__ = "GPL 2.0/LGPL 2.1"
__all__ = ("EmailRepeatInputForm",)

theme = get_theme(request=None, as_instance=True)


class EmailRepeatInputForm(forms.Form, BaseFormFieldPluginForm):
    """Form for ``EmailRepeatInputPlugin``."""
    ...
    def clean(self):
        super(EmailRepeatInputForm, self).clean()

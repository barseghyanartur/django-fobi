...
from fobi.contrib.plugins.form_elements.fields.checkbox_select_multiple.forms \
    import CheckboxSelectMultipleInputForm
from fobi.contrib.plugins.form_elements.fields.checkbox_select_multiple.settings \

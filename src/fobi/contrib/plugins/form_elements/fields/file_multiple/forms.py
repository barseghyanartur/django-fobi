...
__title__ = "file_multiple.forms"
__author__ = "Artur Barseghyan <artur.barseghyan@gmail.com>"
__copyright__ = "2014-2019 Artur Barseghyan"
__license__ = "GPL 2.0/LGPL 2.1"
__all__ = ("FileMultipleInputForm",)

theme = get_theme(request=None, as_instance=True)


class FileMultipleInputForm(forms.Form, BaseFormFieldPluginForm):
    """Form for ``FileMultipleInputPlugin``."""
    ...
    def clean(self):
        super(FileMultipleInputForm, self).clean()

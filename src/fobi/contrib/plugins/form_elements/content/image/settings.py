...
__title__ = 'fobi.contrib.plugins.form_elements.content.image.settings'
...
__all__ = (
    ...
    'FIT_METHODS_CHOICES_WITH_EMPTY_OPTION', 'IMAGES_UPLOAD_DIR', 'SIZES',
    'SIZE_100x100', 'SIZE_200x200', 'SIZE_300x300', 'SIZE_400x400', 'SIZE_500x500',
    'SIZE_600x600', 'DEFAULT_SIZE',
)

from fobi.contrib.plugins.form_elements.content.image.conf import get_setting

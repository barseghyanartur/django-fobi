__title__ = 'fobi.contrib.plugins.form_elements.content.video.conf'
...
from fobi.contrib.plugins.form_elements.content.video import defaults

def get_setting(setting, override=None):
    """
    Get a setting from ``fobi.contrib.plugins.form_elements.content.video`` conf

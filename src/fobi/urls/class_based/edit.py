...
urlpatterns = [
    ...
    # Edit form entry
    url(
        _(r"^forms/edit/(?P<form_entry_id>\d+)/$"),
        # edit_form_entry,
    ...
    # Delete form entry
    url(
        _(r"^forms/delete/(?P<form_entry_id>\d+)/$"),
    ...
    # Export form entry
    url(
        _(r"^forms/export/(?P<form_entry_id>\d+)/$"),
        export_form_entry,
        name="fobi.export_form_entry",
    ),
    # Import form entry
    url(
        _(r"^forms/import/$"), import_form_entry, name="fobi.import_form_entry"
    ),
    # Form importers
    url(
        _(r"^forms/importer/(?P<form_importer_plugin_uid>[\w_\-]+)/$"),
        form_importer,
    ...
    url(
        _(
            r"^forms/elements/add/(?P<form_entry_id>\d+)/"
    ...
    url(
        _(r"^forms/elements/edit/(?P<form_element_entry_id>\d+)/$"),
    ...
    url(
        _(r"^forms/elements/delete/(?P<form_element_entry_id>\d+)/$"),
        # view=delete_form_element_entry,
    ...
    url(
        _(r"^forms/handlers/delete/(?P<form_handler_entry_id>\d+)/$"),
    ...
    url(
        _(r"^wizard/edit/(?P<form_wizard_entry_id>\d+)/$"),
        edit_form_wizard_entry,
        name="fobi.edit_form_wizard_entry",
    ),
    # Delete form wizard entry
    url(
        _(r"^wizard/delete/(?P<form_wizard_entry_id>\d+)/$"),
        delete_form_wizard_entry,
    ...
    url(
        _(
            r"^wizard/forms/add/(?P<form_wizard_entry_id>\d+)/"
    ...
    url(
        _(r"^wizard/elements/delete/(?P<form_wizard_form_entry_id>\d+)/$"),
        delete_form_wizard_form_entry,
    ...
    url(
        _(
            r"^wizard/handlers/add/(?P<form_wizard_entry_id>\d+)/"
    ...
    url(
        _(r"^wizard/handlers/edit/(?P<form_wizard_handler_entry_id>\d+)/$"),
        edit_form_wizard_handler_entry,
        name="fobi.edit_form_wizard_handler_entry",
    ),
    # Delete form wizard handler entry
    url(
        _(r"^wizard/handlers/delete/(?P<form_wizard_handler_entry_id>\d+)/$"),
        delete_form_wizard_handler_entry,
    ...
    url(
        _(r"^wizard/export/(?P<form_wizard_entry_id>\d+)/$"),
        export_form_wizard_entry,
